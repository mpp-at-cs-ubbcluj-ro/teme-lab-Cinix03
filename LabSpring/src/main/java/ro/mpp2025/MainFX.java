...
import ro.mpp2025.ctrl.ComputerRepairShopController;
...
import ro.mpp2025.services.ServicesException;
...
public class MainFX extends Application {
    ...
    static ComputerRepairServices getService() throws ServicesException {
        try {
            ...
            properties.load(new FileInputStream("src\\RepairShop.properties"));
